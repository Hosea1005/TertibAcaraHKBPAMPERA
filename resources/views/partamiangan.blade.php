        ...
        <header class="l-header" id="header">
            ...
            <div class="container" style="background: transparent;">
                <div class="container" style="margin-top: 10%;text-align: center;background: transparent;">
                    <h1 style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Rundown Partamiangan HKBP AMPERA</h1>
                    <?php
                    $tgl=date('Y-m-d');
                    // echo $tgl;
                ?>
                    <h4>Minggu, {{ $tgl }} (tanggal hari ini)</h4>
                </div>
                ...
                <div class="container" style="margin-top: 2%">
                    <h3>6. Doa ("Yang manjabui minggu depan")</h3>
                </div>
                <div class="container" style="margin-top: 2%">
                    <h3>7. Marende</h3>
                    {{-- <pre>{{ $tata->le4 }}</pre> --}}
                ...
                <div class="container" style="margin-top: 2%">
                    <h3>8. Doa ("Yang manjabui hari ini")</h3>
                    {{-- <pre>{{ $tata->epistel }}</pre> --}}
                </div>
                <div class="container" style="margin-top: 2%">
                    <h3>9. Marende ("Persembahan")</h3>
                    {{-- <pre>{{ $tata->le5 }}</pre> --}}
                </div>
                <div class="container" style="margin-top: 2%">
                    <h3>10. Doa Penutup</h3>
                </div>
            </div>
