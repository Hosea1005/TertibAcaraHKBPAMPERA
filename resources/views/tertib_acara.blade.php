            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="{{asset('assets/')}}/img/plate1.png" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="{{asset('assets/')}}/img/plate2.png" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="{{asset('assets/')}}/img/plate3.png" alt="" class="menu__img">
                ...
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <div class="app__stores">
                            <a href="#"><img src="{{asset('assets/')}}/img/app1.png" alt="" class="app__store"></a>
                            <a href="#"><img src="{{asset('assets/')}}/img/app2.png" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="{{asset('assets/')}}/img/movil-app.png" alt="" class="app__img">
                </div>
            </section>
